                  ...
                  <div className="space-y-8 mb-16">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="">
                        ...
                        <p className="text-xs">
                          Write Word #1 displayed on your Nano in position 1 of
                          your Recovery sheet. Then press right on your Nano to
                          display Word #2 and write it down in position 2.
                          Repeat the process for all words while carefully
                          respecting the order and spelling. Press left on your
                          Nano to check for any mistakes.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <>
                  ...
                  <div className="mb-16">
                    ...
                    <p className="mt-8 text-sm text-[gray] ">
                      You are ready to safely manage your crypto. Only one quick
                      step left!
                    </p>
                  </div>
                </>
...
export default First_Time_Nano_X;
