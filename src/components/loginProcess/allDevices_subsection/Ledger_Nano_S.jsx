      ...
      <div className="flex flex-col lg:flex-row justify-around mt-12 px-4 gap-8">
        <div className="text-center lg:text-left">
          <h1 className="text-2xl sm:text-3xl font-semibold">
            FIRST TIME USING <br /> YOUR NANO S?
          </h1>
        </div>
        ...
        <div
          ...
          onClick={() =>
            navigate("/all-devices/ledger-nano-s/first-time-nano-s")
          }
        >
          <img
            src={assets.img6}
      ...
      <div className="flex flex-col lg:flex-row justify-around items-start gap-8 px-4 mt-12">
        ...
        <div className="flex flex-col sm:flex-row lg:flex-col gap-8 items-center">
          ...
          <div
            ...
            onMouseLeave={() => setHoveredCard(null)}
            onClick={() =>
              navigate("/all-devices/ledger-nano-s/connect-nano-s")
            }
          >
            <img
              src={assets.img7}
          ...
          <div
            ...
            onMouseLeave={() => setHoveredCard(null)}
            onClick={() =>
              navigate("/all-devices/ledger-nano-s/restore-recovery-nano-s")
            }
          >
            <img
              src={assets.img8}
